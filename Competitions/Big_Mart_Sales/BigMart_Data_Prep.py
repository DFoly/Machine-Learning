...
train.to_csv('C:/Users/dfoley/Dropbox/Hackathon/Big_Mart_Sales/train_modified.csv', index = False)
test.to_csv('C:/Users/dfoley/Dropbox/Hackathon/Big_Mart_Sales/test_modified.csv', index = False)