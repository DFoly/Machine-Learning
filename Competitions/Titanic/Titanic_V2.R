...
train <- read.csv("C:/Users/dfoley/Dropbox/Hackathon/Titanic/Data/train.csv",na.string = c('NA', ''))
test <- read.csv("C:/Users/dfoley/Dropbox/Hackathon/Titanic/Data/test.csv",na.string = c('NA', ''))
...
summary(all_data$Fare)
all_data$Fare[1044] <- median(all_data[all_data$Pclass == 3 &
                             all_data$Embarked == 'S',]$Fare, na.rm  = T)
